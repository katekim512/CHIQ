# Disabled: offline pseudo supervision is not part of question-only inference.
#
# import os
# import torch
...
#     model = MistralForCausalLM.from_pretrained("models/Mistral-7B-Instruct-v0.2")
# elif model_name == "gemma":
#     tokenizer = AutoTokenizer.from_pretrained("models/gemma-7b-it")
#     model = MistralForCausalLM.from_pretrained("models/gemma-7b-it")
#
# pipe = pipeline(task="text-generation", model=model, tokenizer=tokenizer, torch_dtype=torch.bfloat16, device=5)
#
#
# context_file = "QReCC/test_llama_context_qr.json"
# input_file = "QReCC/test_with_rewritten_q_new.json"
# output_file = "QReCC/llama_test_with_doc_newcontext_search_q.json"
